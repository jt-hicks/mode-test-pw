...
# Vector births/deaths - was a piece-wise constant function that
# changes every 30 days based on a random-walk function, now given as
# an additional variable that we just do not update.
deriv(beta) <- 0
