...
# Removed delay functions and replaced with delay compartments for:
#     FOI - force of infection from mosquitoes to humans
#     FOIv - force of infection from humans to mosquitoes
#     ince - rate from exposed to infected mosquitoes
